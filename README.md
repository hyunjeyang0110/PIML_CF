# PIML_CF
This repository provides deep learning model architectures and implementation code for hurricane-induced compound flooding prediction, integrating physics constraints based on the simplified shallow water equations (SSWEs). To support reproducibility, a lightweight example dataset is included to enable end-to-end training of the PIML framework.
...
## We Investigate
- **_Where_** PIML improves predictions: spatial patterns of performance enhancement.
- **_When_** improvements occur: temporal evolution of model performance.
- **_How_** physics constraints influence model behavior: mechanisms underlying physically consistent predictions.
...
-	Momentum constraints are the dominant contributor to performance enhancement, and PIML shows increasing predictive advantages under limited training data conditions.
